...
In [schemars](index.html) 1.2.1

[Source](https://docs.rs/schemars_derive/1.2.1/x86_64-unknown-linux-gnu/src/schemars_derive/lib.rs.html#32)
...
1. [Supported Serde Attributes](#supported-serde-attributes)
   ...
   - [`with`](#with)
   - [`bound`](#bound)
2. [Supported Validator/Garde Attributes](#supported-validatorgarde-attributes)
